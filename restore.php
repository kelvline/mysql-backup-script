...
define("BACKUP_FILE", 'backup-file_name-20181022_164459.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
class Restore_Database {
    ...
    /**
     * Backup file inside Backup Directory
     */
    var $backupFile;
